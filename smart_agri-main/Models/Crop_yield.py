...
joblib.dump(rf_model, 'D:\CSE - AIML\Batch-15\smart_agri-main\Models\crop_yield.pkl')  # Save the model
joblib.dump(scaler, 'D:\CSE - AIML\Batch-15\smart_agri-main\Models\scaler.pkl')  # Save the scaler
joblib.dump(label_encoder_crop, 'D:\CSE - AIML\Batch-15\smart_agri-main\Models\label_encoder_crop.pkl')  # Save the crop label encoder
joblib.dump(label_encoder_season, 'D:\CSE - AIML\Batch-15\smart_agri-main\Models\label_encoder_season.pkl')  # Save the season label encoder
